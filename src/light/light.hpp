...
{
public:
  const glm::vec3& get_ambient() { return    ambient_; }
    const glm::vec3& get_diffuse() { return  diffuse_; }
    const glm::vec3& get_specular() { return specular_; }
    const glm::vec3& get_position() { return position_; }
